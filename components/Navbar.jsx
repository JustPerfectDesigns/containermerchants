...
import Logo from "../public/images/cm-logo.png";
...
export default function Navbar() {
	...
	return (
		<header className="hidden lg:block mb-8 border-b md:h-20 md:flex md:justify-center md:items-center md:flex-col md:mt-8">
			<div className="flex items-center justify-between md:container">
				...
				<div className="flex divide-x ">
					<Button
						...
						className="flex flex-col gap-y-1.5 h-8 w-12 sm:h-20 sm:w-20 md:h-12 md:w-12 rounded-none relative" // Add relative positioning
					>
						<ShoppingBag size={28} />
						{cartCount > 0 && ( // Display count only if items are in the cart
							<div className="flex justify-center items-center absolute inset-[69%] p-2.5 top-0 right-8 rounded-full bg-red-500">
